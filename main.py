...
# When a string is in a single form like 'Hello world' or "Hellow World" It does not matter weather or not it is in a double quotations or single both give the same output
